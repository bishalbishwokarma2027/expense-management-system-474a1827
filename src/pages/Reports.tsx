  ...
  if (showReportForm) {
    return (
      <div className="space-y-4">
        ...
        <ReportFormView transactions={filteredTx} periodLabel={periodLabel} showNepaliDates={showNepaliDates} previousBalance={previousMonthBalance} previousBalanceLabel="Prev Month Balance" />
      </div>
    );
  }
